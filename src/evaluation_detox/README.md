All the files under this directory are sourced from the [Paradetox project](https://github.com/s-nlp/paradetox/tree/main/evaluation_detox) which are under the CC0 license.
